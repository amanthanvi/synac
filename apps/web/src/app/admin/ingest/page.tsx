  ...
  return (
    <>
      <PageHeader
        badge="Admin"
        title="Ingest"
        subtitle="Runs, items, and review queue."
      />
        ...
        <section className={styles.section}>
          ...
          {enabledSources.length === 0 ? (
            <div className={styles.notice}>
              No enabled sources. Enable + verify a source in{' '}
            ...
            <form action={trigger} className={styles.form}>
              <label className={styles.field}>
                ...
                <select
                  ...
                  name="sourceId"
                  required
                  defaultValue={enabledSources[0]?.id}
                >
              ...
              {runs.map((r) => (
                <li key={r.id} className={browseStyles.item}>
                  ...
                  <p className={browseStyles.itemSummary}>
                    {r.source.name} · started {formatDateTime(r.startedAt)}
                    {r.finishedAt
