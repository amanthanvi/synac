  ...
  return (
    <>
      ...
      <section style={{ marginTop: 18 }}>
        ...
        <form
          action={save}
          style={{ marginTop: 12, display: 'grid', gap: 12, maxWidth: 720 }}
        >
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            <span style={{ opacity: 0.7, fontSize: 12 }}>
              Updated at {tag.updatedAt.toISOString()}
            </span>
          </div>
        </form>
      </section>
      ...
      <section style={{ marginTop: 22 }}>
        ...
        <div style={{ marginTop: 8, opacity: 0.8 }}>
          Moves all entry associations and redirects this slug + history to the
          target tag.
        </div>
